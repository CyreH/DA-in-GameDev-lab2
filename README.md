...
- При данных значениях(0 и 100) хорошая реакция воспроизведется при значении < 0, плоха при значении > 100, в остальных случаях, соответсвтенно, средняя![image](https://user-images.githubusercontent.com/102403656/195170297-acb95df3-e456-4d9c-95c4-8e72e03b0f6a.png)
